...
const ImagePage = ({state, emit, img, albumId}) => {
    const tags = <div class="chips chips-autocomplete"></div>
    const imgPage = <div class="modal image_page" id={'image_' + img._id} style="width:98vw; height:98vh" >
        <img src={'/api/images/' + img.filename} style="width:100%; height: auto" />
